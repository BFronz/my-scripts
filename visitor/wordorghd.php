...
# make organization by heading word table
$WF = fopen("wordorghead2.txt", "w"); 
$query = "select heading, oid, org ";
$query .= "from thomvisitor_cat_tool ";
...
for ($i=0; $i<mysql_numrows($result); $i++)
  {
   ...
   $vhd  = mysql_result($result, $i, "heading"); 
