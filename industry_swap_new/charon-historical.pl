...
updateTable("UPDATE $table SET industry='Other'		                        WHERE   industry IN ('Associations','Hospitality & Travel','Hospitality &amp; Travel','Media & Entertainment','Media &amp; Entertainment','NA','Recreation','Unclassified','Other/Consultants','Personal Services','Industry','Services','Basic','Detailed','unclassified')  ");
